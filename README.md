<h3 align="center">
  <br />
  <img src="https://dart.dev/assets/img/shared/dart/logo+text/horizontal/white.svg" alt="logo" width="800" />
  <br />
  <br />
  <br />
</h3>

# Dart for Javascript/Nodejs Developers

> Examples of [Dart Lang](https://dart.dev/) examples compared to Javascript/[Node.js](https://nodejs.org/) for learning

[![License](http://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/sanathusk/dart-for-javascript-developers/blob/99943635d5f6d462b36f77db2bca89dfb1bfc2df/LICENSE)

[![PRs Welcome](https://img.shields.io/badge/PRs-welcome-brightgreen.svg)](#contributing)

This guide full of examples is intended for people learning Dart that are coming from Javascript/Node.js, although the vice versa can work too. This is not meant to be a complete guide and it is assumed that you've gone through the [Tour of Go](https://tour.golang.org/) tutorial. This guide is meant to be barely good enough to help you at a high level understand how to do *X* in *Y* and doing further learning on your own is of course required.
